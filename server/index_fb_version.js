...
app.get('/googlecca0672d18f37dcb.html', function(request, response) {
  response.sendFile(
    path.resolve(__dirname, '../react-ui/public', 'googlecca0672d18f37dcb.html')
  );
});
...
app.post('/add-newsletter-subscription', function(req, res) {
  ...
  requestGlobal.post(
    {
      url:
        'https://api.hubapi.com/contacts/v1/contact/?hapikey=47bdc73e-0284-4c6d-9a7b-dac3e55f1259',
      json: body
    },
